...
rule masurca_scaffold_samba:
    input:
        ...
        draft = "result/{sample}/intermediate/assembly_flye/polished/polca/{sample}_assembly_polca4.fasta"
    output:
        "result/{sample}/intermediate/assembly_masurca/polished/polca/{sample}_racon5_polca4_samba.fasta"
    params:
	...
	cd {params.outdir}
        ...
        mv *_polca4.fasta.scaffolds.fa {wildcards.sample}_polca4_samba.fasta
