...
rule medaka_consensus:
	...
	trimmed_reads = "result/{sample}/intermediate/nanopore/{sample}_trimmed.fastq"
    output:
    ...
    conda:
        "../../workflow/env/medaka.yml"
    shell:
        """
        mkdir -p {params.outdir}
        medaka_consensus -i "{input.trimmed_reads}" -d "{input.assembly}" -o "{params.outdir}"
